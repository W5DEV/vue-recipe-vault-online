<template>
  <div
    class="flex flex-col w-full justify-start items-center mt-14 p-8 pb-16 bg-gray-900">
    <div
      class="flex flex-col w-full h-full justify-start items-start bg-white rounded-3xl p-16">
      <h1
      ...
      <div
        ...
        <ul class="list-disc text-gray-700 lg:text-lg xl:text-xl py-4">
          ...
          <li class="my-1 mx-12">
            Create a "Favorites" section that will allow users to save recipes
            to a list and display under user dashboard.
          </li>
        </ul>
      </div>
    </div>
