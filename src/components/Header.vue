<template>
  <Popover class="bg-primary relative">
    <div class="mx-auto max-w-7xl px-1 md:px-4 sm:px-6">
      <div class="flex items-center justify-between py-6">
        <div class="flex justify-start md:mr-8 lg:flex-1">
          <RouterLink
            ...
            <!-- Logo -->
            <LogoWhite class="w-10 md:w-auto h-auto" />
            <span
        ...
        <div class="flex items-center justify-end flex-1 lg:w-0">
          <RouterLink
            to="/"
            class="text-primary-white hover:text-primary-muted text-base lg:text-xl font-medium mx-4 hidden md:flex"
            >Home</RouterLink
          >
          <RouterLink
            to="/demo"
